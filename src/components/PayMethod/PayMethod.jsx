  ...
  return (
    <div>
      ...
      <section css={sectionStyles}>
        <ul css={ulStyles} className="pay-method">
          <li>
            <input type="radio" id="payMethodCard" name="select-pay-method" />
            <label htmlFor="payMethodCard">신용/체크카드</label>
          </li>
          <li>
            <input type="radio" id="payMethodBank" name="select-pay-method" />
            <label htmlFor="payMethodBank">무통장 입금</label>
          </li>
          <li>
            <input type="radio" id="payMethodPhone" name="select-pay-method" />
